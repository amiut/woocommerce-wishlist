<?php
/**
 * WooCommerceWishlist Entry Data Class
 *
...
abstract class Data
{
	...
	public function save() {
		 ...
		 */
		do_action( 'dweb_wishlist_before_' . $this->object_type . '_object_save', $this, $this->data_store );
		 ...
		 * @param DATA_Store_WP $data_store THe data store persisting the data.
		 */
		do_action( 'dweb_wishlist_after_' . $this->object_type . '_object_save', $this, $this->data_store );
	...
	protected function get_hook_prefix() {
		return 'dweb_wishlist_' . $this->object_type . '_get_';
	}
