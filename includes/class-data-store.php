<?php
/**
 * WooCommerceWishlist Data Store.
 *
...
class Data_Store {
	 ...
	 * Ran through `dweb_wishlist_data_stores`.
	 *
	 * @var array
	 */
	...
	public function __construct( $object_type ) {
		...
		$this->stores      = apply_filters( 'dweb_wishlist_data_stores', $this->stores );
	 ...
	 *
	 * @since 1.0.0
	 * @param DATA $data dweb_wishlist data instance.
	 */
